...
RUN go get -u github.com/DagensNyheter/logstash_exporter
RUN cd $GOPATH/src/github.com/DagensNyheter/logstash_exporter && /go-shizzle/bin/govendor build +local
